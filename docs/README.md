# SnakeBiteRx documentation

Short, focused pages. Start with the [main README](../README.md) for setup (`make setup` after clone).

| Doc | What it covers |
|-----|----------------|
| [Quickstart](QUICKSTART.md) | First-time setup from zero (Python, API, Flutter) |
| [Models & scores](MODELS_AND_SCORES.md) | Checkpoints, class outputs, confidence, fusion |
